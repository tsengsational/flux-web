import { defineComponent, computed, ref, mergeProps, unref, createVNode, resolveDynamicComponent, withCtx, watch, openBlock, createBlock, Fragment, renderList, createCommentVNode, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderList, ssrRenderVNode, ssrRenderComponent, ssrInterpolate, ssrGetDirectiveProps, ssrRenderAttr, ssrRenderTeleport } from 'vue/server-renderer';
...
const __nuxt_component_0 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$2, [["__scopeId", "data-v-d5985fb7"]]), { __name: "NestedList" });
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderTeleport(_push, (_push2) => {
        if (__props.isOpen && __props.imageId) {
          _push2(`<div class="fixed inset-0 z-[150] flex items-center justify-center bg-stage-950/95 backdrop-blur-xl" data-v-0d0a14c2><button class="absolute top-6 right-6 z-[160] p-3 text-stage-400 hover:text-stage-50 transition-colors bg-stage-900/40 rounded-full hover:bg-stage-800/80 focus:outline-none focus:ring-2 focus:ring-brand-500" aria-label="Close Lightbox" data-v-0d0a14c2><svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" data-v-0d0a14c2><path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" data-v-0d0a14c2></path></svg></button><div class="relative flex flex-col items-center justify-center p-4 max-w-[95vw] max-h-[95vh]" data-v-0d0a14c2><img${ssrRenderAttrs(mergeProps(unref(getImageProps)(__props.imageId, { sm: 800, md: 1200, lg: 1920 }, { quality: 90 }), {
            class: "max-w-full max-h-[85vh] object-contain shadow-2xl rounded-sm animate-scale-in",
            alt: __props.alt || "Expanded image"
          }))} data-v-0d0a14c2>`);
          if (__props.caption) {
            _push2(`<div class="mt-4 text-stage-300 font-serif italic text-sm text-center max-w-2xl px-6 py-2 bg-stage-900/40 rounded-lg backdrop-blur-sm" data-v-0d0a14c2>${ssrInterpolate(__props.caption)}</div>`);
          } else {
            _push2(`<!---->`);
          }
          _push2(`</div></div>`);
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/BaseLightbox.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const __nuxt_component_3 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$1, [["__scopeId", "data-v-0d0a14c2"]]), { __name: "BaseLightbox" });
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const lightboxImageId = ref(null);
    const lightboxCaption = ref(null);
    const closeLightbox = () => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_BaseLightbox, {
        "is-open": unref(isLightboxOpen),
        "image-id": unref(lightboxImageId),
        caption: unref(lightboxCaption),
